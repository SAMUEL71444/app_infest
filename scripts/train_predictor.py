...
Why this exists
---------------
The competition's headline model is the Oblivious Gradient-Boosted Tree
...
model = {
    "_comment": "Lightweight client-side logistic regression for the live predictor. "
                "The competition headline model is the Oblivious Gradient-Boosted Tree (ROC-AUC 0.993); this LR is a "
